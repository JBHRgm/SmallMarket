...
async function initalize_dataset () {
    ...
    // Kategorien anlegen
    let cat_arr = [
        { name: 'Fahrzeuge', ref: 0 },{ name: 'Autos & Zubehör', ref: 1 },{ name: 'Boote & Zubehör', ref: 1 },{ name: 'Laster & Zubehör', ref: 1 },{ name: 'Motorräder & Zubehör', ref: 1 },{ name: 'Nutzfahrzeuge & Zubehör', ref: 1 },
